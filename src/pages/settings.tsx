...
const Settings: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="max-w-screen-sm mx-auto flex flex-col min-h-[100dvh] w-full h-full justify-between relative gap-y-4 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 overflow-hidden">
        <div className="settings-column flex-1 flex flex-col gap-4 w-full max-w-[100dvw] rounded-lg shadow-xl p-2 sm:px-4 md:px-8 lg:px-12 xl:px-16 pt-0 pb-0 items-center overflow-hidden">
          ...
          <div className="w-full flex items-center justify-center py-2 sm:py-4 mb-8">
            <BackArrowButton />
          </div>
        </div>
      </main>
